...
# example.com/ansible-nginx-operator-bundle:$VERSION and example.com/ansible-nginx-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/ansible-nginx-operator
